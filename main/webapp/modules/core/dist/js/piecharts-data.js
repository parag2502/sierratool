...
function getUrlVars() {
  ...
  window.onload = function(){	
	var projectid = getUrlParam('project','empty');
	if(projectid == 'empty') {
		alert('Project not found please go to sierra tool and perform check duplicate function again after that visit this page from dashboard button.')
		window.location = window.location.origin;
	}
	else {
		var valid = getCookie(projectid+'v');
		if(valid == '' || valid < 0) {
			alert('Project not found please go to sierra tool and perform check duplicate function again after that visit this page from dashboard button.')
			window.location = window.location.origin;
		}
...
var echartsConfig = function() { 
	var projectid = getUrlParam('project','empty');
	var valid = getCookie(projectid+'v');
	var dubpicate = parseInt(getCookie(projectid+'d'));
	var incomplete = parseInt(getCookie(projectid+'i'));
	...
	if( $('#e_chart_22').length > 0 ){
		var eChart_22 = echarts.init(document.getElementById('e_chart_22'));
			...
			series: [
				{
					...
					type:'pie',
					radius : '55%',
					color: ['#f83f37', '#ffbf36', '#22af47'],
					data:[
						{value:dubpicate, name:'Duplicate'},
